...
const UserIcon = () => <svg xmlns="http://www.w.org/2000/svg" className="h-5 w-5 text-slate-500" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zM8 12a6 6 0 00-6 6h12a6 6 0 00-6-6z" clipRule="evenodd" /></svg>;
const LogoutIcon = () => <svg xmlns="http://www.w.org/2000/svg" className="h-5 w-5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" /></svg>;

const Header: React.FC<{ setView: (view: 'app' | 'profile') => void }> = ({ setView }) => {
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl z-20 border border-slate-100">
                <div className="py-1">
                  ...
                  <button onClick={signOut} className="w-full text-left flex items-center space-x-3 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100">
                    <LogoutIcon />
                    <span>Logout</span>
                  </button>
                </div>
